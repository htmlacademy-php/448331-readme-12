                  ...
                  <div class="form__text-inputs-wrapper">
                    <div class="form__text-inputs">
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-header']) ?>">
                          <input class="adding-post__input form__input" id="text-heading" type="text" name="post-header" placeholder="Введите заголовок" value="<?=getPostVal('post-header'); ?>">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-header']; ?></p>
                          </div>
                        </div>
                      </div>
                      <div class="adding-post__textarea-wrapper form__textarea-wrapper">
                        <label class="adding-post__label form__label" for="post-text">Текст поста <span class="form__input-required">*</span></label>
                        <div class="form__input-section <?=is_error_field($errors['post-text']) ?>">
                      ...
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-tag']) ?>">
                          <input class="adding-post__input form__input" id="post-tags" type="text" name="post-tag" placeholder="Введите теги" value="<?=getPostVal('post-tag'); ?>">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-tag']; ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="form__text-inputs-wrapper">
                    <div class="form__text-inputs">
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-header']) ?>">
                          <input class="adding-post__input form__input" id="quote-heading" type="text" name="post-header" placeholder="Введите заголовок" value="<?=getPostVal('post-header'); ?>">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-header']; ?></p>
                      ...
                      <div class="adding-post__input-wrapper form__textarea-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-text']) ?>">
                          <textarea class="adding-post__textarea adding-post__textarea--quote form__textarea form__input" id="cite-text" name="post-text" placeholder="Текст цитаты" ><?=getPostVal('post-text'); ?></textarea>
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-text']; ?></p>
                      ...
                      <div class="adding-post__textarea-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['quote-author']) ?>">
                      ...
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-tag']) ?>">
                          <input class="adding-post__input form__input" id="cite-tags" type="text" name="post-tag" placeholder="Введите теги" value="<?=getPostVal('post-tag'); ?>">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-tag']; ?></p>
                  ...
                  <div class="form__text-inputs-wrapper">
                    <div class="form__text-inputs">
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-header']) ?>">
                          <input class="adding-post__input form__input" id="photo-heading" type="text" name="post-header" placeholder="Введите заголовок" value="<?=getPostVal('post-header'); ?>">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-header']; ?></p>
                      ...
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['photo-link']) ?>">
                          ...
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['photo-link']; ?></p>
                          </div>
                        </div>
                      </div>
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-tag']) ?>">
                          <input class="adding-post__input form__input" id="photo-tags" type="text" name="post-tag" placeholder="Введите теги" value="<?=getPostVal('post-tag'); ?>">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-tag']; ?></p>
                  ...
                  <div class="adding-post__input-file-container form__input-container form__input-container--file">
                    <div class="adding-post__input-file-wrapper form__input-file-wrapper">
                      <div class="adding-post__file-zone adding-post__file-zone--photo form__file-zone dropzone">
                        <input class="adding-post__input-file form__input-file" id="userpic-file-photo" type="file" name="added-photo-file" title=" ">
                  ...
                  <div class="form__text-inputs-wrapper">
                    <div class="form__text-inputs">
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-header']) ?>">
                          <input class="adding-post__input form__input" id="video-heading" type="text" name="post-header" placeholder="Введите заголовок" value="<?=getPostVal('post-header'); ?>">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-header']; ?></p>
                      ...
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['video-link']) ?>">
                          ...
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['video-link']; ?></p>
                          </div>
                        </div>
                      </div>
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-tag']) ?>">
                          <input class="adding-post__input form__input" id="video-tags" type="text" name="post-tag" placeholder="Введите ссылку" value="<?=getPostVal('post-tag'); ?>">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-tag']; ?></p>
                  ...
                  <div class="form__text-inputs-wrapper">
                    <div class="form__text-inputs">
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-header']) ?>">
                          <input class="adding-post__input form__input" id="link-heading" type="text" name="post-header" placeholder="Введите заголовок" value="<?=getPostVal('post-header'); ?>">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-header']; ?></p>
                      ...
                      <div class="adding-post__textarea-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-link']) ?>">
                      ...
                      <div class="adding-post__input-wrapper form__input-wrapper">
                        ...
                        <div class="form__input-section <?=is_error_field($errors['post-tag']) ?>">
                          <input class="adding-post__input form__input" id="link-tags" type="text" name="post-tag" placeholder="Введите ссылку" value="<?=getPostVal('post-tag'); ?>">
                          <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
                          <div class="form__error-text">
                            <h3 class="form__error-title">Заголовок сообщения</h3>
                            <p class="form__error-desc"><?=$errors['post-tag']; ?></p>
